...
$back = new moodle_url('/local/my_team/');
echo '<div class="main-wrap pb-3">
        <div class="row p-4">
            <a href="'.$back.'" class="btn btn-primary">
                <i class="fa fa-arrow-left" aria-hidden="true"></i>
                '.get_string('backtomyteam', 'local_my_team').'
            </a>
        </div>
        ...
        <div class="user-assign-wrap row px-2 py-4">
            <div class="col-md-5">
                <div class="form-group">
                    <label for="assignedusersbox"><h6>'.get_string('assignedusers', 'local_my_team').'</h6></label>
                    <select multiple class="form-control pl-0" id="assignedusersbox" name="assignedusersbox[]" >
                    </select>
                </div>
                <div class="">
                    <label><h6>'.get_string('search').'</h6></label>
            ...
            <div class="col-md-5">
                <div class="form-group">
                    <label for="availableusersbox"><h6>'.get_string('availableusers', 'local_my_team').'</h6></label>
