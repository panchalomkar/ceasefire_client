...
define(['jquery',
    'theme_remui/select2',
    // 'local_people/bootstrapValidator',
     lang_locale,
    'theme_remui/bootbox',
    'theme_remui/notify',
    'core/modal_factory',
    ...
    'core/modal_events',
    'core/str'
    ], function ($, Select2, bootstrapvalidator,lang_locale, bootbox, notify, ModalFactory, datetimepicker, ModalEvents, str) {
        ...
        init: function (params) {
            $(document).ready(function () {
                ...
                var onInput = function (e) {
                    ...
                    if (!isEmptyForm(this)) {
                        ...
                        $.when(editaPresent).done(function(localizedEditString) {
                            ...
                            $('.panel-heading h5', $reset).append(reset);
                ...
                $('div.reset').click(function (e) {
                    ...
                    $("#form-" + id).closest(".filterslist").find('.panel-heading .reset').click();  
                });
...
//                    $(id).bootstrapValidator('revalidateField', id + 'lt');
//                    $(id).bootstrapValidator('revalidateField', id + 'gt');
                        ...
                        if(!$(this).data('showmodal')){
                            ...
                            if(q){
                                ...
                                .done(function(modal) {
                                    ...
                                    switch ($name) {
                                        case 'cohortadd':
//                                            $('#frmcohortsadd #cohortlist').select2({
//                                                width: '100%',
//                                                placeholder : { id : '-1', text : strChoose},
//                                                allowClear: false,
//                                            });
                                    ...
                                    modal.getRoot().on(ModalEvents.save, function(e) {
                                        ...
                                        if($(fieldToValidate).length > 0 && $(fieldToValidate).val() != ''){
                                            $.ajax({
                                                ...
                                                data: {
                                                    action: $name,
                                                    modaldata: JSON.stringify({users: users, input_value: $(fieldToValidate).val()}),
                                                    getter: false,
                                                },
                                                dataType: 'json',
                                                async: false,
