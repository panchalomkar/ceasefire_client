...
switch ($action) {
    ...
    case 'GETREDEEMPOINTS':
	  //  print_object($_POST);
        ...
        echo 'Total Points Available : ' . $av_points . '<br>';
        echo 'Average Course Score : '. round(get_user_grade($USER->id), 2) .'%<br>';
        echo '<table class="bg-white table table-hover">
            <thead>
            <tr><td style="text-align:center;"> Please Visit the Reward Portal for more details on redemption <br><a href="http://rewards.ceasefire.biz" target="_blank" >http://rewards.ceasefire.biz</a> </td></tr>
            </thead>';
           /*echo  '<tbody>
            <tr><td>' . $av_points . '</td>
               <td>' . $redeemable . ' (*<i>2000 points can be redeem at once</i>)</td>
