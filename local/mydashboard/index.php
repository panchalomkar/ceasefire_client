...
<script src="morris/SimpleChart.js"></script>
<script>
    ...
    var graphdata1 = {
        ...
        // title: "Monday",
        values: [
            {X: "LOGIN", Y: <?php echo $l; ?>},
            {X: "QUIZ", Y: <?php echo $q; ?>},
            {X: "SPIN", Y: <?php echo $s; ?>},
            {X: "REWARD", Y: <?php echo $r; ?>}
...
<script src="external/jquery.min.js" integrity="sha512-3P8rXCuGJdNZOnUx/03c1jOTnMn3rP63nBip5gOP2qmUh5YAdVAvFZ1E+QLZZbC1rtMrQb+mah3AfYW11RUrWA==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>
