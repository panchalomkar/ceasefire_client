...
if ($hassiteconfig) {
    ...
    $settings->add(new admin_setting_configselect('local_mydashboard/welcome_point', 
    ...
    $settings->add(new admin_setting_configselect('local_mydashboard/quiz_scratch_card', 
           get_string('quiz_scratch_card', 'local_mydashboard'), 
            get_string('quiz_scratch_card_desc', 'local_mydashboard'), 
            0, 
            $choices));
    
    $settings->add(new admin_setting_configselect('local_mydashboard/rank_promote', 
    ...
    $settings->add(new admin_setting_configselect('local_mydashboard/dailyquiz_point', 
    ...
    $settings->add(new admin_setting_heading('loginpoint_heading', get_string('loginpoints', 'local_mydashboard'), 
     ...
     $settings->add(new admin_setting_configselect('local_mydashboard/loginpoint_day1', 
            get_string('login_day1', 'local_mydashboard'),'', 
            0, 
            $points));
     $settings->add(new admin_setting_configselect('local_mydashboard/loginpoint_day2', 
            get_string('login_day2', 'local_mydashboard'),'', 
            0, 
            $points));
     $settings->add(new admin_setting_configselect('local_mydashboard/loginpoint_day3', 
            get_string('login_day3', 'local_mydashboard'),'', 
            0, 
            $points));
     $settings->add(new admin_setting_configselect('local_mydashboard/loginpoint_day4', 
            get_string('login_day4', 'local_mydashboard'),'', 
            0, 
            $points));
     $settings->add(new admin_setting_configselect('local_mydashboard/loginpoint_day5', 
