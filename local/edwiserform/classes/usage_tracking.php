...
class usage_tracking {
    ...
    private function get_plugin_settings($plugin) {
        ...
        if ($filterplugininstalled != null) {
            ...
            $filteredpluginconfig['filter_edwiserformlink_active'] = isset($filter->active) ? $filter->active : false;
            $filteredpluginconfig['filter_edwiserformlink_sortorder'] = isset($filter->sortorder) ? $filter->sortorder : false;
        }
