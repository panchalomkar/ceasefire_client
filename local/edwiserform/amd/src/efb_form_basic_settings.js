...
define(['jquery'], function ($) {
    $(document).ready(function() {
        ...
        $("#id_notifi_email").parent().prepend('<div class="notifi-email-group"><input type="email" class="notifi-email-group-input form-control" id="notifi-email-group-input"/><div>' + M.util.get_string('efb-recipient-email-desc', 'local_edwiserform') + '</div></div>');
        $("#id_notifi_email").hide();
        $('#id_notifi_email_body').after(M.util.get_string('efb-email-body-restore-desc', 'local_edwiserform', {
            id: '#id_notifi_email_bodyeditable',
            string: 'efb-notify-email-body'
        }));
        $('#id_confirmation_msg').after(M.util.get_string('efb-email-body-restore-desc', 'local_edwiserform', {
        ...
        function get_body_tags() {
            var tags = M.util.get_string('efb-email-body-tags', 'local_edwiserform');
        ...
        $('body').on('click', '.efb-email-show-tags>a', function() {
            ...
            $(this).text($(this).next().hasClass('show') ? M.util.get_string('efb-email-hide-tags', 'local_edwiserform') : M.util.get_string('efb-email-show-tags', 'local_edwiserform'));
        });
        $("#id_notifi_email_body").parents('.felement').siblings().append('<div class="efb-email-show-tags"><a href="#">' + M.util.get_string('efb-email-hide-tags', 'local_edwiserform') + '</a>' + get_body_tags() + '</div>');
        $("#id_confirmation_msg").parents('.felement').siblings().append('<div class="efb-email-show-tags"><a href="#">' + M.util.get_string('efb-email-hide-tags', 'local_edwiserform') + '</a>' + get_body_tags() + '</div>');
