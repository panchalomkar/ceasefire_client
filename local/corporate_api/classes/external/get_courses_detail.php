...
trait get_courses_detail {
    ...
    public static function get_courses_detail($userid) {
        ...
        $getsqlss = "SELECT e.courseid FROM {enrol} e 
                ...
                foreach ($courses as $value) {
                    ...
                    $activities[] = [
                        ...
                        'courseendate' => DATE('Y-m-d', $course->enddate),
        ...
        $response = array(
            "countactivity" => json_encode($activitiescount),
            "countsevendays" => json_encode($activitiescount),
            "countthirtydays" => json_encode($activitiescount),

            "evendata" => json_encode($geteventdetail),
            "allcourses" => json_encode($activities)
        );
