...
/**
 * Course user neighbours cleaderboard.
 *
 * @package    block_xp
 * @copyright  2018 Frédéric Massart
 * @author     Frédéric Massart <fred@branchup.tech>
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class neighboured_cleaderboard implements cleaderboard {
     ...
     */
    public function __construct(cleaderboard $cleaderboard, $objectid, $neighbours, $fallbackontop = false) {
    ...
    public function get_rank($id) {
        ...
        return $id == $this->objectid ? $this->cleaderboard->get_rank($id) : null;
    }
    ...
    public function get_ranking(limit $limit) {
        ...
        return $this->cleaderboard->get_ranking($limit);
    }
