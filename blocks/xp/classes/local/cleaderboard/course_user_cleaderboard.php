...
/**
 * Course user state cleaderboard.
 *
 * @package    block_xp
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class course_user_cleaderboard implements cleaderboard {
     ...
     *
     * The position is used to determine how to paginate the cleaderboard.
     *
     * @param int $id The object ID.
