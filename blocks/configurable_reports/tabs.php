...
//print_object($reportclass->components);
//unset($reportclass->components[1]);
//unset($reportclass->components[2]);
unset($reportclass->components[6]);
unset($reportclass->components[4]);
unset($reportclass->components[7]);
unset($reportclass->components[5]);
foreach ($reportclass->components as $comptab) {
//	print_object($comptab);
