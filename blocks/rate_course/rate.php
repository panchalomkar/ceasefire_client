...
/**
 * Show error message on rating submit if value less than 0
 * @author Dnyaneshwar K
 * @since 01-05-2019
 * @ticket #410 
 */
echo "<div id='rate_error' class='hidden'>".get_string('rating_alt0', 'block_rate_course')."</div>";
// Now output the form.
echo '<form method="post" id="course-rate-form" action="'.
...
echo '</p><p><input type="submit" id="rate-course-submit" value="'.get_string('submit', 'block_rate_course').'"';
if ($existing_answer) {
    echo 'disabled';
}
echo '/></p></form>';
