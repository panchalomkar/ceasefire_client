        ...
        $this->add_setting(
            ...
            [
                ...
                'options' => [
                    ...
                    [
                        'name' => 'remuiicon3',
                        'label' => get_string('icondesign3', 'theme_remui'),
                        'img' => new moodle_url('/theme/remui/pix/icon_style4.png')
                    ],
                    [
                        'name' => 'remuiicon4',
                        'label' => get_string('icondesign4', 'theme_remui'),
                        'img' => new moodle_url('/theme/remui/pix/icon_style5.png')
                    ]
                ]
            ]
        );
