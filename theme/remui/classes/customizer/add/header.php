...
trait header {
    ...
    private function header_settings() {
        ...
        $this->add_setting(
            ...
            [
                ...
                'options' => [
                    ...
                    'logo' => get_string('logo', 'theme_remui'),
        ...
        $this->add_setting(
            ...
            [
                ...
                'options' => [
                    ...
                    'top' => get_string('header-top', 'theme_remui'),
        ...
        $label = get_string('layout-mobile', 'theme_remui');
        $backgroundselector = 'header-primary-layout-mobile';
        $this->add_setting(
            'select',
            $backgroundselector,
            $label,
            'header-primary',
            [
                'help' => get_string('layout-mobile_help', 'theme_remui'),
                'default' => 'top',
                'options' => [
                    'left' => get_string('header-left', 'theme_remui'),
                    'top' => get_string('header-top', 'theme_remui'),
