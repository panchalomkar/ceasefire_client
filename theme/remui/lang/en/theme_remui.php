...
$string['remuisettings'] = 'RLMS Settings';
...
$string['logoorsitenamedesc'] = 'Logo - Only the logo will be shown; <br /> Icon+sitename - An icon along with the sitename will be shown. <br/> Site name with logo - Site name and logo will displayed(Header layout top icon bottom menu only)';
...
$string['frontpagedesigndesc'] = 'Enable Legacy Builder or RLMS Homepage builder';
...
$string['poweredbyedwiser'] = 'Powered by RLMS';
$string['poweredbyedwiserdesc'] = 'Uncheck to remove  \'Powered by RLMS\' from your site.';
...
// About Edwiser RemUI.
$string['aboutsettings'] = 'About RLMS';
...
$string['poweredby'] = 'Powered by RLMS';
...
$string['invalidjsonfile'] = 'Error: Invalid json of RLMS product list.';
...
$string['enrolment_layout_desc'] = 'Enable RLMS Layout for new and improved Enrolment Page design.';
$string['disable'] = 'Disable';
$string['defaultlayout'] = 'Default Moodle layout';
$string['enable_layout1'] = 'RLMS Layout';
...
$string['edwiserlayout'] = 'RLMS Layout';
...
$string['sendfeedback'] = "Send Feedback to RLMS";
...
$string['importer-missing'] = 'RLMS Site Importer plugin is missing. Please visit <a href="https://edwiser.org">Edwiser</a> site to download this plugin.';
...
$string["noti_completion"] = 'RLMS has improved your student engagement levels: You have a total of <b>{$a->completion} course completions</b> this month';

$string["noti_enrol"] = 'Your LMS design looks great with RLMS: You have <b>{$a->enrolment} new course enrollments</b> in your portal this month';
...
$string["icondesign3"] = "Light header, Dark sidebar";
$string["icondesign4"] = "Dark header, Light sidebar";

$string["formselementdesign"] = "Form Element Design";
$string["settings_home"] = "Admin Settings";
$string["coursecarddesign"] = "RLMS Course card layout";
