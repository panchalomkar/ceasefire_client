...
//           $mform->addElement('html', '</a>');            
        ...
        $bu =  array('none' => 'None', 'BLR' => 'Bangalore', 'DEL' => 'Delhi','TRV' => 'Trivandrum','HYD' => 'Hyderabad','IXE' => 'Mangalore','CHQ'=>'Mumbai');
       
        //getting cost center
         $select = $mform->addElement('select', 'sessioncostcenter', get_string('sessioncostcenter','ilt'),$bu);
        if(!empty($mysession->costcenter))
            $mform->getElement('sessioncostcenter')->setSelected($mysession->costcenter);
        /*
        * @Author VaibhavG
        * @desc #10: ILT Custom work - Assign multiple instructors in ILT Session
        * @desc 11Dec2018
