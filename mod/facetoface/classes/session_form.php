...
class mod_facetoface_session_form extends moodleform {
    ...
    public function definition() {
        ...
        //set session name
        $sessionname = $mform->addElement('text', 'sessionname', get_string('sessionname', 'facetoface'));        
        $mform->addRule('sessionname', get_string('sessionname', 'facetoface'), 'required', null);
        ...
        $get_session = $DB->get_records_sql('SELECT * FROM mdl_facetoface_sessions  WHERE id = ?',array($s));
